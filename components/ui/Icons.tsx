...
export const LogoutIcon: FC<IconsProps> = ({ size, variant, className }) => {
  return (
    <Logout size={size} className={cn(IconsVariants({ variant, className }))} />
  );
};
...
export const AlertIcon: FC<IconsProps> = ({ size, variant, className }) => {
  return (
    <Alert size={size} className={cn(IconsVariants({ variant, className }))} />
  );
};

export const ErrorIcon: FC<IconsProps> = ({ size, variant, className }) => {
  return (
    <Error size={size} className={cn(IconsVariants({ variant, className }))} />
  );
};

export const InformationIcon: FC<IconsProps> = ({
  size,
  variant,
  className,
}) => {
  return (
    <Info size={size} className={cn(IconsVariants({ variant, className }))} />
  );
};
export const ChevronDownIcon: FC<IconsProps> = ({
  size,
  variant,
  className,
}) => {
...
export const ChevronRightIcon: FC<IconsProps> = ({
  size,
  variant,
  className,
}) => {
...
export const ChevronLeftIcon: FC<IconsProps> = ({
  size,
  variant,
  className,
}) => {
...
export const SocialIcon: FC<IconsProps> = ({ size, variant, className }) => {
  return (
    <Social size={size} className={cn(IconsVariants({ variant, className }))} />
  );
};
...
export const MenuIcon: FC<IconsProps> = ({ size, variant, className }) => {
  return (
    <Menu size={size} className={cn(IconsVariants({ variant, className }))} />
  );
};

export const MailIcon: FC<IconsProps> = ({ size, variant, className }) => {
  return (
    <Mail size={size} className={cn(IconsVariants({ variant, className }))} />
  );
};
...
export const HeartIcon: FC<IconsProps> = ({ size, variant, className }) => {
  return (
    <Heart size={size} className={cn(IconsVariants({ variant, className }))} />
  );
};

export const LearnIcon: FC<IconsProps> = ({ size, variant, className }) => {
  return (
    <Learn size={size} className={cn(IconsVariants({ variant, className }))} />
  );
};
...
export const GoalIcon: FC<IconsProps> = ({ size, variant, className }) => {
  return (
    <Goal size={size} className={cn(IconsVariants({ variant, className }))} />
  );
};

export const CreateIcon: FC<IconsProps> = ({ size, variant, className }) => {
  return (
    <Create size={size} className={cn(IconsVariants({ variant, className }))} />
  );
};
...
export const ChatIcon: FC<IconsProps> = ({ size, variant, className }) => {
  return (
    <Chat size={size} className={cn(IconsVariants({ variant, className }))} />
  );
};
...
export const SearchIcon: FC<IconsProps> = ({ size, variant, className }) => {
  return (
    <Search size={size} className={cn(IconsVariants({ variant, className }))} />
  );
};

export const PlusIcon: FC<IconsProps> = ({ size, variant, className }) => {
  return (
    <Plus size={size} className={cn(IconsVariants({ variant, className }))} />
  );
};

export const XIcon: FC<IconsProps> = ({ size, variant, className }) => {
  return (
    <X size={size} className={cn(IconsVariants({ variant, className }))} />
  );
};
...
export const ImageIcon: FC<IconsProps> = ({ size, variant, className }) => {
  return (
    <Image size={size} className={cn(IconsVariants({ variant, className }))} />
  );
};

export const VideoIcon: FC<IconsProps> = ({ size, variant, className }) => {
  return (
    <Video size={size} className={cn(IconsVariants({ variant, className }))} />
  );
};
