...
export const InputVariants = cva(
    'peer order-2 rounded-md border-primary-400 py-1 px-2 text-text text-primary-600 focus:text-primary-950 placeholder:text-primary-600 ' +
        ' outline-none focus:outline-none focus:border-primary-400 focus:ring-1 focus:ring-offset-0 focus:ring-primary-600 ' +
        'invalid:outline-none invalid:ring-offset-0 invalid:ring-alert invalid:border-alert invalid:ring-0 ' +
        'invalid:focus:outline-none invalid:outline-1 invalid:focus:ring-offset-0 invalid:focus:ring-alert invalid:focus:border-alert invalid:focus:ring-1 ' +
