...
const Markdown: FC<MarkdownProps> = forwardRef<HTMLParagraphElement, MarkdownProps>(({ rawText, ...props }, ref) => {
    ...
    return <p ref={ref} {...props} dangerouslySetInnerHTML={{ __html: innerHtml }} />;
});
