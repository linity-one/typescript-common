        ...
        function ({ addBase, theme }: PluginAPI) {
            addBase({
                h1: {
                    ...
                    fontSize: (theme('fontSize.2xl')?.[0]) || '64px',
                    lineHeight: (theme('fontSize.2xl')?.[1]) || '80px',
                },
                h2: {
                    fontWeight: theme('fontWeight.normal') || '400',
                    fontFamily: theme('fontFamily.title') || ['Cairo', 'sans-serif'],
                    letterSpacing: '0.025em',
                    fontSize: (theme('fontSize.xxl')?.[0]) || '48px',
                    lineHeight: (theme('fontSize.xxl')?.[1]) || '64px',
                },
                h3: {
                    fontWeight: theme('fontWeight.semi-bold') || '550',
                    fontFamily: theme('fontFamily.title') || ['Cairo', 'sans-serif'],
                    letterSpacing: '0.025em',
                    fontSize: (theme('fontSize.xl')?.[0]) || '27px',
                    lineHeight: (theme('fontSize.xl')?.[1]) || '32px',
                },
                h4: {
                    fontWeight: theme('fontWeight.semi-bold') || '550',
                    fontFamily: theme('fontFamily.title') || ['Cairo', 'sans-serif'],
                    letterSpacing: '0.025em',
                    fontSize: (theme('fontSize.lg')?.[0]) || '21px',
                    lineHeight: (theme('fontSize.lg')?.[1]) || '24px',
                },
                p: {
                    fontWeight: theme('fontWeight.normal') || '400',
                    fontFamily: theme('fontFamily.body') || ['Cairo', 'sans-serif'],
                    fontSize: (theme('fontSize.base')?.[0]) || '17px',
                    lineHeight: (theme('fontSize.base')?.[1]) || '20px',
                },
                label: {
                    fontWeight: theme('fontWeight.normal') || '400',
                    fontFamily: theme('fontFamily.body') || ['Cairo', 'sans-serif'],
                    fontSize: (theme('fontSize.sm')?.[0]) || '14px',
                    lineHeight: (theme('fontSize.sm')?.[1]) || '16px',
                },
                [`@media (min-width: ${theme('screens.tablet')})`]: {
                    '.text-subtext': { fontSize: (theme('fontSize.sm')?.[0]) || '14px', lineHeight: (theme('fontSize.sm')?.[1]) || '16px' },
                    '.text-text': { fontSize: (theme('fontSize.base')?.[0]) || '17px', lineHeight: (theme('fontSize.base')?.[1]) || '20px' },
                    '.text-h1': {
                        fontSize: (theme('fontSize.2xl')?.[0]) || '64px',
                        lineHeight: (theme('fontSize.2xl')?.[1]) || '80px',
                        letterSpacing: '0.05em',
                    ...
                    p: { fontSize: (theme('fontSize.lg')?.[0]) || '21px', lineHeight: (theme('fontSize.lg')?.[1]) || '24px' },
                    label: { fontSize: (theme('fontSize.lg')?.[0]) || '21px', lineHeight: (theme('fontSize.lg')?.[1]) || '24px' },
                },
                [`@media (max-width: ${theme('screens.tablet')})`]: {
                    '.text-subtext': { fontSize: (theme('fontSize.sm')?.[0]) || '14px', lineHeight: (theme('fontSize.sm')?.[1]) || '16px' },
                    '.text-text': { fontSize: (theme('fontSize.base')?.[0]) || '17px', lineHeight: (theme('fontSize.base')?.[1]) || '20px' },
                    '.text-h3': { fontSize: (theme('fontSize.lg')?.[0]) || '21px', lineHeight: (theme('fontSize.lg')?.[1]) || '24px', letterSpacing: '0.025em' },
                    '.text-h2': { fontSize: (theme('fontSize.xl')?.[0]) || '27px', lineHeight: (theme('fontSize.xl')?.[1]) || '32px', letterSpacing: '0.025em' },
                    '.text-h1': { fontSize: (theme('fontSize.xxl')?.[0]) || '48px', lineHeight: (theme('fontSize.xxl')?.[1]) || '64px', letterSpacing: '0.05em' },
                    h1: { fontSize: (theme('fontSize.xxl')?.[0]) || '48px', lineHeight: (theme('fontSize.xxl')?.[1]) || '64px', letterSpacing: '0.05em' },
                    h2: { fontSize: (theme('fontSize.xl')?.[0]) || '27px', lineHeight: (theme('fontSize.xl')?.[1]) || '32px', letterSpacing: '0.025em' },
                    h3: { fontSize: (theme('fontSize.lg')?.[0]) || '21px', lineHeight: (theme('fontSize.lg')?.[1]) || '24px', letterSpacing: '0.025em' },
                    p: { fontSize: (theme('fontSize.base')?.[0]) || '17px', lineHeight: (theme('fontSize.base')?.[1]) || '20px' },
                    label: { fontSize: (theme('fontSize.sm')?.[0]) || '14px', lineHeight: (theme('fontSize.sm')?.[1]) || '16px' },
                },
            })
        },
